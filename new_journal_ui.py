...
class JournalApp:
    ...
    def __init__(self, root):
        ...
        self.root.configure(bg='#181818')  # Dark background for Instagram-like feel
        ...
        title_label = tk.Label(self.main_frame, text="Journal Manager", font=("Helvetica", 22, "bold"),
                               bg='#181818', fg='white')
        ...
        self.add_entry_btn = tk.Button(self.main_frame, text="Add Entry", command=self.add_entry, 
                                       bg='#3897f0', fg='white', font=("Helvetica", 14, "bold"), 
        ...
        # Footer Label
        footer_label = tk.Label(self.main_frame, text="Created with tkinter", font=("Helvetica", 10),
                                bg='#181818', fg='gray')
